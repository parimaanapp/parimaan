...
describe('ApiStack', () => {
  ...
  it('declares exactly 44 AppSync Lambda data sources', () => {
    const template = synth('dev');
    template.resourceCountIs('AWS::AppSync::DataSource', 44);
  });
  ...
  it('declares exactly 44 resolvers total', () => {
    const template = synth('dev');
    template.resourceCountIs('AWS::AppSync::Resolver', 44);
  });
